...
function aoi_responsive_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'aoi-responsive-main' ),
		'id'            => 'sidebar-1',
	...
	// Area 7, located in the top. Empty by default.
		register_sidebar( array(
			...
			'before_widget' => '<div id="%1$s" class="col-sm-12 widget-container %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h4 class="widget-title">',
			'after_title' => '</h4>',
		) );

		// Area 8, located in the top. Empty by default.
		register_sidebar( array(
			'name' => __( 'Center Top Widget Area', 'twentyten' ),
			'id' => 'center-top-widget-area',
			'description' => __( 'The center top widget area', 'twentyten' ),
			'before_widget' => '<div id="%1$s" class="col-sm-4 widget-container %2$s">',
			'after_widget' => '</div>',
			'before_title' => '<h4 class="widget-title">',
			'after_title' => '</h4>',
		) );

		// Area 9, located in the top. Empty by default.
		register_sidebar( array(
...
function aoi_responsive_scripts() {
	wp_enqueue_style( 'aoi-responsive-main-style', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
